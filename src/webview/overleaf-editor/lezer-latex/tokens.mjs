...
import {
  ...
  LabelCtrlSeq,
  GlossaryReferenceCtrlSeq,
  GlossaryDisplayCtrlSeq,
  MathTextCtrlSeq,
  HboxCtrlSeq,
  TitleCtrlSeq,
  AuthorCtrlSeq,
...
import {
  glossaryDisplayCommands,
  glossaryReferenceCommands,
} from './glossary-commands.mjs'
...
export const specializeCtrlSeq = (name, terms) => {
  ...
  if (glossaryReferenceCommands.has(name)) {
    return GlossaryReferenceCtrlSeq
  }
  if (glossaryDisplayCommands.has(name)) {
    return GlossaryDisplayCtrlSeq
  }
